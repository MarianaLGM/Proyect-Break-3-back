...
const ServicesControllers = {
    ...
    async getByTratamientoFacial(req, res) {
        try {
            ...
            console.log(error)
            res.status(500).json({ message: "Error al obtener los tratamientos faciales" });
        }
    },
    ...
    async getByTratamientoCorporal(req, res) {
        try {
            ...
            console.log(error)
            res.status(500).json({ message: "Error al obtener los tratamientos corporales" });
        }
    },
    ...
    async updateById(req, res) {
        try {
            ...
            console.log(error)
            res.status(500).json({ message: "Error al modificar el servicio" });
        }
    },
